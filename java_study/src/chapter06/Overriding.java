...
// 2. 오버라이딩 구현 방법 
// - 부모클래스의 상속받음 메서드를 자식 클래스에서 다시 정의 
// - 메서드의 이름, 매개변수를 일치, 반환타입은 같거나 자동 형변환 가능하게 작성 
...
public class Overriding {
	public static void main(String[] args) {
		...
		// : 해당 상태나 동작을 반드시 가지지만 상속받는 클래스마다 차이를 두고 싶을때
		
		// === 오버로딜 VS 오버라이딩 ===
		// : 모두 메서드의 이름을 재사용하는 방법(다형성)
		
		// 1. 오버로딩 
		// - 같은 클래스 내에서 같은 이름을가진 메서드를 여러 개 정의 
